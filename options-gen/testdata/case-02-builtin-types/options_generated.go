...
func _validate_Options_optValInt(o *Options) error {
	if err := _getOptsValidatorOrDefault(o).Var(o.optValInt, "required"); err != nil {
...
func _validate_Options_optValInt8(o *Options) error {
	if err := _getOptsValidatorOrDefault(o).Var(o.optValInt8, "required"); err != nil {
...
func _validate_Options_optValInt16(o *Options) error {
	if err := _getOptsValidatorOrDefault(o).Var(o.optValInt16, "required"); err != nil {
...
func _validate_Options_optValInt32(o *Options) error {
	if err := _getOptsValidatorOrDefault(o).Var(o.optValInt32, "required"); err != nil {
...
func _validate_Options_optValInt64(o *Options) error {
	if err := _getOptsValidatorOrDefault(o).Var(o.optValInt64, "required"); err != nil {
...
func _validate_Options_optValUInt(o *Options) error {
	if err := _getOptsValidatorOrDefault(o).Var(o.optValUInt, "required"); err != nil {
...
func _validate_Options_optValUInt8(o *Options) error {
	if err := _getOptsValidatorOrDefault(o).Var(o.optValUInt8, "required"); err != nil {
...
func _validate_Options_optValUInt16(o *Options) error {
	if err := _getOptsValidatorOrDefault(o).Var(o.optValUInt16, "required"); err != nil {
...
func _validate_Options_optValUInt32(o *Options) error {
	if err := _getOptsValidatorOrDefault(o).Var(o.optValUInt32, "required"); err != nil {
...
func _validate_Options_optValUInt64(o *Options) error {
	if err := _getOptsValidatorOrDefault(o).Var(o.optValUInt64, "required"); err != nil {
...
func _validate_Options_optValFloat32(o *Options) error {
	if err := _getOptsValidatorOrDefault(o).Var(o.optValFloat32, "required"); err != nil {
...
func _validate_Options_optValFloat64(o *Options) error {
	if err := _getOptsValidatorOrDefault(o).Var(o.optValFloat64, "required"); err != nil {
...
func _validate_Options_optValString(o *Options) error {
	if err := _getOptsValidatorOrDefault(o).Var(o.optValString, "required"); err != nil {
...
func _validate_Options_optValBytes(o *Options) error {
	if err := _getOptsValidatorOrDefault(o).Var(o.optValBytes, "required"); err != nil {
...
func _validate_Options_optValBool(o *Options) error {
	if err := _getOptsValidatorOrDefault(o).Var(o.optValBool, "required"); err != nil {
