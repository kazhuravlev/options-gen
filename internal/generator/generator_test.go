		...
		Options: []generator.OptionMeta{
			{
				...
				Field:     "stringer",
				Type:      "fmt.Stringer",
				TagOption: generator.TagOption{IsRequired: true, GoValidator: "required", Default: "", Variadic: false},
			},
			{
				Name:      "Str",
				...
				Field:     "str",
				Type:      "string",
				TagOption: generator.TagOption{IsRequired: false, GoValidator: "required", Default: "", Variadic: false},
			},
			{
				Name:      "SomeMap",
				Docstring: "",
			...
			},
			{
				...
				Field:     "boolTrue",
				Type:      "bool",
				TagOption: generator.TagOption{IsRequired: false, GoValidator: "", Default: "true", Variadic: false},
			},
			{
				Name:      "BoolFalse",
				Docstring: "",
				Field:     "boolFalse",
				Type:      "bool",
				TagOption: generator.TagOption{IsRequired: false, GoValidator: "", Default: "false", Variadic: false},
			},
			{
				Name:      "NoValidation",
				Docstring: "// multi\n// line\n// \n// comment",
				Field:     "noValidation",
				Type:      "string",
				TagOption: generator.TagOption{IsRequired: false, GoValidator: "", Default: "", Variadic: false},
			},
			{
				Name:      "StarOpt",
				Docstring: "",
				Field:     "starOpt",
				Type:      "*int",
				TagOption: generator.TagOption{IsRequired: true, GoValidator: "", Default: "", Variadic: false},
			},
			{
				Name:      "SliceOpt",
				Docstring: "",
			...
			},
			{
				...
				Field:     "oldStyleOpt3",
				Type:      "string",
				TagOption: generator.TagOption{IsRequired: true, GoValidator: "min=10,required", Default: "", Variadic: false},
			},
			{
				Name:      "PublicOption1",
				Docstring: "",
			...
			},
			{
				...
				Type:      "time.Duration",
				TagOption: generator.TagOption{IsRequired: false, GoValidator: "", Default: "1m", Variadic: false},
			},
		},
	}, spec)
}
	...
	req.Equal(t, &generator.OptionSpec{
		...
		Options: []generator.OptionMeta{
			...
			},
			{
				...
				Field:     "opt3",
				Type:      "int",
				TagOption: generator.TagOption{IsRequired: false, GoValidator: "min=10", Default: "", Variadic: false},
			},
			{
				Name:      "Opt4",
				Docstring: "",
