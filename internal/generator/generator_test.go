		...
		Options: []generator.OptionMeta{
			{
				...
				Field:     "stringer",
				Type:      "fmt.Stringer",
				TagOption: generator.TagOption{IsRequired: true, GoValidator: "required", Default: "", Skip: false},
			},
			{
				Name:      "Str",
				...
				Field:     "str",
				Type:      "string",
				TagOption: generator.TagOption{IsRequired: false, GoValidator: "required", Default: "", Skip: false},
			},
			{
				Name:      "SomeMap",
				Docstring: "",
			...
			},
			{
				...
				Field:     "boolTrue",
				Type:      "bool",
				TagOption: generator.TagOption{IsRequired: false, GoValidator: "", Default: "true", Skip: false},
			},
			{
				Name:      "BoolFalse",
				Docstring: "",
				Field:     "boolFalse",
				Type:      "bool",
				TagOption: generator.TagOption{IsRequired: false, GoValidator: "", Default: "false", Skip: false},
			},
			{
				Name:      "NoValidation",
				Docstring: "// multi\n// line\n// \n// comment",
				Field:     "noValidation",
				Type:      "string",
				TagOption: generator.TagOption{IsRequired: false, GoValidator: "", Default: "", Skip: false},
			},
			{
				Name:      "StarOpt",
				Docstring: "",
				Field:     "starOpt",
				Type:      "*int",
				TagOption: generator.TagOption{IsRequired: true, GoValidator: "", Default: "", Skip: false},
			},
			{
				Name:      "SliceOpt",
				Docstring: "",
			...
			},
			{
				...
				Field:     "oldStyleOpt3",
				Type:      "string",
				TagOption: generator.TagOption{IsRequired: true, GoValidator: "min=10,required", Default: "", Skip: false},
			},
			{
				Name:      "PublicOption1",
				Docstring: "",
			...
			},
			{
				...
				Type:      "time.Duration",
				TagOption: generator.TagOption{IsRequired: false, GoValidator: "", Default: "1m", Skip: false},
			},
		},
	}, spec)
}
	...
	req.Equal(t, &generator.OptionSpec{
		...
		Options: []generator.OptionMeta{
			...
			},
			{
				...
				Field:     "opt3",
				Type:      "int",
				TagOption: generator.TagOption{IsRequired: false, GoValidator: "min=10", Default: "", Skip: false},
			},
			{
				Name:      "Opt4",
				Docstring: "",
